...
public class User {
    ...
    public Date getLastPasswordAt() {
        return lastPasswordAt;
    }

    public void setLastPasswordAt(Date lastPasswordAt) {
    ...
    public void setLastTenant(String lastTenant) {
        this.lastTenant = lastTenant == null ? null : lastTenant.trim();
    }
